...
class rep():
    ...
    def perf(self):
        ...
        bench_data = pd.read_csv(root_path+'/Daily Data/Benchmark/Benchmark Price Data.csv' ,index_col=0)
    ...
    def mets(self):
        ...
        df = pd.read_csv(root_path + '/Daily Data/Portfolio/Asset Fundis.csv')
